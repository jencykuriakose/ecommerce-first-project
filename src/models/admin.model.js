...
// const productDatabase=require("../models/product.model");
...
//     const sale=await orderDatabase.aggregate([
//         {
//             $match:{
//                 date: { $gte: startOfYear, $lte: currentDate },
//                 status: { $in: ['processing', 'shipped', 'delivered'] },
...
//     const prodcuts=await productDatabase.aggregate([
//         {
//             $match:{createAt: {$gte:startOfYear,$lte:currentDate}},
//         },
//         {
//             $group:{
//                 _id:{
...
//       currentMonthEarnings,
//     ] = await Promise.all([
//       adminModel.calculateTotalRevenue(),
//       adminModel.calculateTotalOrdersCount(),
//       adminModel.calculateTotalProductsCount(),
//       adminModel.calculateTotalCategoriesCount(),
//       adminModel.calculateCurrentMonthEarnings(),
//     ]);
